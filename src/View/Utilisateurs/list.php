...
foreach ($utilisateurs as $utilisateur) {
    ...
    echo '<div id="action" "><a href ="index.php?action=update&controller=utilisateur&idUtilisateur=' .
        $urlidentifiant . '"><img class="modifier" src = "..\web\images\modifier.png"  alt="modifier"></a >
                     <a href ="index.php?action=delete&controller=utilisateur&idUtilisateur=' .
        $urlidentifiant . '"><img class="delete" src = "..\web\images\delete.png"  alt="supprimer"></a></div>';
}
