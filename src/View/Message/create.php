...
<form class="custom-form" method="post" action="index.php?controller=message&action=readKeyword">
    <fieldset>
        ...
        <p>
            <label for="motclef"></label><input style="max-width: 300px" placeholder="Rechercher un utilisateur"
                                                type="text"
...
if (isset($utilisateurs)) {
    foreach ($utilisateurs as $utilisateur) {
        echo '<div class="contact">
            ...
            <a style="min-width: 100%" href="index.php?controller=message&action=read&idContact=' . rawurlencode($utilisateur->getIdentifiant()) . '#dernierMessage">Envoyer un message</a>
            </div>';
    }
}
?>
